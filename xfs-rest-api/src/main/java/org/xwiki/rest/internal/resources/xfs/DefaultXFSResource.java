 ...
 */
package org.xwiki.rest.internal.resources.xfs;
...
import org.xwiki.rest.resources.xfs.XFSResource;

/**
 * @version $Id$
 */
@Component
@Named("org.xwiki.rest.internal.resources.xfs.DefaultXFSResource")
public class DefaultXFSResource implements XFSResource, XWikiRestComponent
{
    ...
    private final FilterStreamType inputFilterStreamType = new FilterStreamType(SystemType.XWIKI, "xfs", "1.0");
    ...
    @Override
    public void putXFS(String wikiName, InputStream xfs) throws XWikiRestException
    {
        OutputStreamOutputTarget outputStream = new DefaultOutputStreamOutputTarget(null, true);

        // Create map of parameters
        FilterEventParameters inputParameters = this.getInputParameters(xfs);
