...
public class XFFReader
{
    ...
    private String extractFilePath(Path path)
    {
        String filePath = "";
        String sep = "";
        ...
        while (pathIterator.hasNext()) {
            ...
            if (counter % 2 != 0 || (!"wikis".equals(element) && !"spaces".equals(element) && !"pages".equals(element))) {
        ...
        if (indexEntry != null) {
            ...
            while (index.hasMoreElements()) {
                ...
                if (!id.equals(previousId)) {
                    ...
                    try {
                        reader = this.componentManager.getInstance(Reader.class, hint);
                        reader.open(id, null, filter, proxyFilter);
                        ...
                        zf.close();
                        String message =
                            String.format("Incorrect '%s' file, cannot get the corresponding Reader.",
    ...
    // TODO: This method should use the 'index.txt' file; it's likely to fail for now
        ...
        while (index.hasMoreElements()) {
            ...
            if (!id.equals(previousId)) {
                ...
                try {
                    ...
                    String message =
                        String
                            .format("Incorrect '%s' file, cannot get the corresponding Reader.", Index.INDEX_FILENAME);
                    throw new FilterException(message, e);
                }
            }
            String relativeFilePath = extractFilePath(path);
