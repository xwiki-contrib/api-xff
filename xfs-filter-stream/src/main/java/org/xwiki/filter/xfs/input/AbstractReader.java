 ...
 */
package org.xwiki.filter.xfs.input;
...
import org.xwiki.filter.xfs.internal.input.XFSInputFilter;
import org.xwiki.model.reference.EntityReference;

/**
 * Abstract class that each element from XFS (wiki, space, page, object, class, etc.) should implement.
 * 
 * @version $Id$
 * @since 7.1
 */
public abstract class AbstractReader
{
     ...
     */
    protected XFSInputFilter proxyFilter;
     ...
     */
    public AbstractReader(Object filter, XFSInputFilter proxyFilter)
    {
        this.filter = filter;
    ...
    /**
     * Push a new file to the reader. When a XFS is read, it's read file by file. The master filter (XFSFilter) will
