...
import org.xwiki.filter.xfs.input.AbstractReader;
import org.xwiki.model.reference.AttachmentReference;
import org.xwiki.model.reference.DocumentReference;
import org.xwiki.model.reference.EntityReference;

/**
 * Read file from XFS and parse them or reroute them to child readers.
 * 
 * @version $Id$
 * @since 7.1
 */
public class AttachmentReader extends AbstractReader
{
     ...
     */
    public AttachmentReader(Object filter, XFSInputFilter proxyFilter)
    {
