...
@AllComponents
@Scope("xfs")
public class XFSIntegrationTest
{
    @BeforeClass
    public static void beforeClass() throws Exception
    {
        ...
        File xfsDirSrc = new File("target/test-classes/packagefile/xfs/xwiki");
        File xfsDirDst = new File(folder.toString() + "/xwiki");
        FileUtils.copyDirectoryStructure(xfsDirSrc, xfsDirDst);
