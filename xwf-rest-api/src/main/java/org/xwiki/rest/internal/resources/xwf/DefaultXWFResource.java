 ...
 */
package org.xwiki.rest.internal.resources.xwf;
...
import org.xwiki.rest.resources.xwf.XWFResource;

/**
 * @version $Id$
 */
@Component
@Named("org.xwiki.rest.internal.resources.xwf.DefaultXWFResource")
public class DefaultXWFResource implements XWFResource, XWikiRestComponent
{
    ...
    private final FilterStreamType inputFilterStreamType = new FilterStreamType(SystemType.XWIKI, "xwf", "1.0");
    ...
    @Override
    public void putXWF(String wikiName, InputStream xwf) throws XWikiRestException
    {
        OutputStreamOutputTarget outputStream = new DefaultOutputStreamOutputTarget(null, true);

        // Create map of parameters
        FilterEventParameters inputParameters = this.getInputParameters(xwf);
